...
type ArticleTocWindow = Window &
  typeof globalThis & {
    ...
    articleTocDesktopAbortController?: AbortController;
    articleTocScrollTween?: gsap.core.Tween | null;
  };

const articleWindow = window as ArticleTocWindow;

export function initArticleTocDesktop() {
  articleWindow.articleTocDesktopAbortController?.abort();

  const abortController = new AbortController();
  articleWindow.articleTocDesktopAbortController = abortController;
